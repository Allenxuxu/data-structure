...
static  void  __list_add(struct  list_head *__new , struct list_head *prev, struct  list_head *next)
{
    next->prev = __new;
    __new->next = next;
    __new->prev = prev;
 ...
 */
static void list_add(struct list_head *__new, struct list_head *head)
{
 ...
 */
static void list_add_tail(struct list_head *__new, struct list_head *head)
{
